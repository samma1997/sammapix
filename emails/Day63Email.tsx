    ...
    <Html lang="en">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={body}>
            {toolsUsed < 8
              ? `You've used ${toolsUsed} out of 20 tools so far. There are ${20 - toolsUsed} more waiting for you- from Photo Map to Film Filters to AI Photo Sort.`
              : "You're a power user! You've explored a solid chunk of SammaPix's 20 tools. Keep going."}
          </Text>
