...
(() => {
  ...
  function o(e2, t2 = globalThis, n2 = ["*"]) {
    t2.addEventListener("message", function s2(a2) {
      ...
      const { id: l2, type: u2, path: p2 } = Object.assign({ path: [] }, a2.data), h2 = (a2.data.argumentList || []).map(v);
      let f2;
      try {
        ...
        switch (u2) {
          case "GET":
            ...
            break;
          case "SET":
            t3[p2.slice(-1)[0]] = v(a2.data.value), f2 = true;
            break;
          case "APPLY":
            f2 = n3.apply(t3, h2);
            break;
  ...
  function d(e2, r2 = [], i2 = function() {
    ...
    const a2 = new Proxy(i2, { get(t2, i3) {
      ...
      if ("then" === i3) {
        if (0 === r2.length)
          return { then: () => a2 };
        const t3 = E(e2, { type: "GET", path: r2.map((e3) => e3.toString()) }).then(v);
      ...
      u(s2);
      const [a3, o2] = y(i3);
      return E(e2, { type: "SET", path: [...r2, n2].map((e3) => e3.toString()), value: a3 }, o2).then(v);
    }, apply(n2, i3, a3) {
      u(s2);
      const o2 = r2[r2.length - 1];
      if (o2 === t)
        return E(e2, { type: "ENDPOINT" }).then(v);
      if ("bind" === o2)
        return d(e2, r2.slice(0, -1));
      const [c2, l2] = m(a3);
      return E(e2, { type: "APPLY", path: r2.map((e3) => e3.toString()), argumentList: c2 }, l2).then(v);
    }, construct(t2, n2) {
      u(s2);
      const [i3, a3] = m(n2);
      return E(e2, { type: "CONSTRUCT", path: r2.map((e3) => e3.toString()), argumentList: i3 }, a3).then(v);
    } });
  ...
  function b(e2) {
    if (e2 instanceof File || e2 instanceof R || null === e2)
      return e2;
    const t2 = {};
  ...
  function P(e2, t2 = "") {
    ...
    for (const r2 of Object.keys(e2))
      e2[r2] instanceof File || e2[r2] instanceof R || null === e2[r2] ? n2.push({ file: e2[r2] || r2, path: t2 }) : n2.push(...P(e2[r2], `${t2}${r2}/`));
    return n2;
  }
  function S(e2, t2) {
    const n2 = t2.split("/");
  ...
  var A = class {
    ...
    async getFilesObject() {
      ...
      return (await this.client.listFiles()).forEach((e2) => {
        const [t2, n2] = S(this._content, e2.path);
        "FILE" === e2.type && (t2[n2] = new R(e2.fileName, e2.size, e2.path, e2.lastModified, this));
      }), this._processed = 1, b(this._content);
    }
    getFilesArray() {
      return this.getFilesObject().then((e2) => P(e2));
    }
    ...
    async extractFiles(e2 = void 0) {
      ...
      return (await this.client.extractFiles()).forEach((t3) => {
        const [n2, r2] = S(this._content, t3.path);
      ...
      }), this._processed = 2, null === (t2 = this.worker) || void 0 === t2 || t2.terminate(), b(this._content);
    }
  };
  var _;
  var k;
  ...
  var O = class _O {
    ...
    static async open(e2) {
      const t2 = _O.getWorker(_O._options), n2 = await _O.getClient(t2, _O._options), r2 = new A(e2, n2, t2);
    ...
    static getWorker(e2) {
      return e2.getWorker ? e2.getWorker() : new Worker(e2.workerUrl || new URL("./worker-bundle.js", import_meta.url), { type: "module" });
    }
  ...
  O._options = {}, Promise.withResolvers || (Promise.withResolvers = function() {
    var e2, t2, n2 = new this(function(n3, r2) {
      e2 = n3, t2 = r2;
    });
    return { resolve: e2, reject: t2, promise: n2 };
  });

  // src/libarchive-entry.mjs
  self.LibArchive = O;
})();
