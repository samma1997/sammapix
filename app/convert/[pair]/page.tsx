      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        ...
        <section aria-labelledby="tools-heading" className="mt-10">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/convert" className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm border border-[#6366F1]/30 dark:border-[#6366F1]/20 rounded-md text-[#6366F1] hover:bg-[#6366F1]/5 bg-white dark:bg-[#1E1E1E] transition-colors">
              All conversions
