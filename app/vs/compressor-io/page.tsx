    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose Compressor.io if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Need to compress a single image quickly</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Want a very simple, minimal interface</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> File size is under 10 MB</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">Compressor.io</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              SammaPix uses Google Gemini to analyze each image and generate an SEO-optimized filename and alt text. Upload <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">photo_2024.jpg</code>, get back <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">blue-denim-jacket-product-photo.webp</code>- automatically. Compressor.io has no AI features whatsoever; it only compresses.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Need batch compression with full privacy?</h2>
