    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose Optimizilla if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Prefer a familiar, established tool you&apos;ve used for years</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Only need basic JPEG and PNG compression with a slider</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">Optimizilla</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              After compressing in Optimizilla, your files retain their original names- <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">DSC_0042-min.jpg</code> tells Google nothing about the image content. SammaPix&apos;s AI rename uses Google Gemini to analyze the image and suggest a descriptive, SEO-friendly filename like <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">mountain-lake-sunrise-reflection.webp</code>. This directly improves image search ranking and accessibility.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="mb-14 p-6 border border-gray-200 dark:border-[#2A2A2A] rounded-md bg-gray-50/40 dark:bg-[#1E1E1E]">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mb-4">Who should switch from Optimizilla to SammaPix?</h2>
        ...
        <ul className="space-y-3 text-sm text-gray-600 dark:text-[#A3A3A3]">
          <li className="flex items-start gap-3">
            ...
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You regularly compress more than 20 images.</strong> SammaPix Pro handles 500 files per batch, and even the free plan resets with each session without friction.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You work with sensitive or private images.</strong> Optimizilla uploads every file. SammaPix never sends anything outside your browser.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You publish images to a website.</strong> WebP conversion, AI rename, and EXIF removal are all part of a complete web image workflow- and SammaPix offers all three.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You care about Core Web Vitals.</strong> Smaller WebP files with descriptive filenames and stripped metadata improve both performance scores and image SEO simultaneously.</span>
          </li>
        </ul>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Link href="/tools/webp" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Convert any image to WebP- faster pages, smaller files</p>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400 dark:text-[#737373] group-hover:text-gray-600 transition-colors" strokeWidth={1.5} />
          </Link>
        </div>
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Looking for a better free image compressor?</h2>
