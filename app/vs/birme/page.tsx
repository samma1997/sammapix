    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose Birme if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Only need bulk resizing with no other features</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Are familiar with Birme&apos;s interface and workflow</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">Birme</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              After resizing in Birme, your files still have names like <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">image_1_resized.jpg</code>. SammaPix&apos;s AI rename uses Google Gemini to analyze each image and generate a descriptive, keyword-rich filename automatically. For anyone publishing images to a website or e-commerce store, this is a direct SEO improvement- not just an optimization step.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="mb-14 p-6 border border-gray-200 dark:border-[#2A2A2A] rounded-md bg-gray-50/40 dark:bg-[#1E1E1E]">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mb-4">Who should switch from Birme to SammaPix?</h2>
        ...
        <ul className="space-y-3 text-sm text-gray-600 dark:text-[#A3A3A3]">
          <li className="flex items-start gap-3">
            ...
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You publish images to a website.</strong> Web-ready images need to be compressed, in WebP format, and properly named for SEO. SammaPix covers all three steps.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You have resized images but still need to compress them.</strong> Rather than switching between tools, SammaPix handles both in one session.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">Your image files still contain GPS or device metadata.</strong> SammaPix strips EXIF data before download - Birme does not.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You want a tool that will be supported long-term.</strong> SammaPix is actively developed and ships new features regularly.</span>
          </li>
        </ul>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/tools/resizepack" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Bulk resize images by pixels or percentage- free</p>
            </div>
          ...
          <Link href="/tools/compress" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Compress JPG, PNG, WebP- no upload required</p>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400 dark:text-[#737373] group-hover:text-gray-600 transition-colors" strokeWidth={1.5} />
          </Link>
        </div>
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Need more than just bulk resize?</h2>
