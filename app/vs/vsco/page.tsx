    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose VSCO if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Edit photos on your phone and share to Instagram</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Love VSCO&apos;s curated film presets for aesthetic editing</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Want a community feed and social discovery</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">VSCO</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
              <Camera className="h-4 w-4 text-gray-500 dark:text-[#737373]" strokeWidth={1.5} />
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              Search engines cannot see images- they read filenames and alt text. A file named <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">IMG_4829.jpg</code> contributes nothing to your SEO. SammaPix uses Google Gemini to analyze each image and generate a descriptive, keyword-rich filename and alt text automatically. Upload your Lisbon trip photos, get back <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">lisbon-sunset-alfama-rooftop-golden-hour.webp</code> with a full alt description. VSCO has no SEO features whatsoever- it&apos;s not built for web publishing.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="mb-14 p-6 border border-gray-200 dark:border-[#2A2A2A] rounded-md bg-gray-50/40 dark:bg-[#1E1E1E]">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mb-4">The travel photographer&apos;s workflow</h2>
        ...
        <ol className="space-y-2 text-sm text-gray-600 dark:text-[#A3A3A3]">
          <li className="flex items-start gap-3">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gray-200 text-gray-600 dark:text-[#A3A3A3] text-xs flex items-center justify-center font-medium mt-0.5">1</span>
            <span>Shoot on your camera or phone. Import to VSCO for color grading and film preset styling.</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gray-200 text-gray-600 dark:text-[#A3A3A3] text-xs flex items-center justify-center font-medium mt-0.5">2</span>
            <span>Export full-resolution JPGs from VSCO to your desktop.</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gray-200 text-gray-600 dark:text-[#A3A3A3] text-xs flex items-center justify-center font-medium mt-0.5">3</span>
            <span>Drop all photos into SammaPix. Enable EXIF strip, convert to WebP, run AI rename.</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gray-200 text-gray-600 dark:text-[#A3A3A3] text-xs flex items-center justify-center font-medium mt-0.5">4</span>
            <span>Download ZIP and upload directly to WordPress, Webflow, or your static site generator.</span>
          </li>
        </ol>
        <p className="text-sm text-gray-500 dark:text-[#737373] mt-4">
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Optimize your travel photos in minutes</h2>
