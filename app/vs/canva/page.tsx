    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose Canva if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Create social media graphics, presentations, or branded content</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Collaborate with a team on design assets</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Need a built-in template library and stock photos</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">Canva</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              SammaPix uses Google Gemini to look at each image and generate a descriptive, SEO-optimized filename and alt text. Drop in a folder of product photos with names like <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">photo_001.jpg</code>, and get back <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">red-leather-handbag-womens-fashion.webp</code> with matching alt text. Canva has no equivalent feature- it preserves the original filename you uploaded.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/tools/webp" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-[#E5E5E5]">Convert to WebP</p>
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Convert any image to WebP- free, in-browser, no upload</p>
            </div>
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Need image optimization, not graphic design?</h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "SammaPix vs Canva", item: `${APP_URL}/vs/canva` },
            ],
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is SammaPix better than Canva?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "SammaPix and Canva serve different purposes. Canva is a graphic design platform for creating social media graphics, presentations, and marketing materials. SammaPix is a specialized image optimization tool for compression, WebP conversion, and SEO-optimized renaming. If you need to design graphics, use Canva. If you need to optimize images for web publishing, use SammaPix.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Canva offers a free tier with millions of templates and design elements. Canva Pro is $15 per month and unlocks premium templates, brand kits, expanded storage, and advanced export options including WebP.",
                },
              },
              {
                "@type": "Question",
                name: "What can SammaPix do that Canva can't?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "SammaPix offers image optimization features that Canva does not provide: WebP conversion for free, batch processing of up to 20 images simultaneously, AI-powered image renaming and alt text generation, EXIF metadata removal for privacy, and 100% in-browser processing with no server uploads.",
                },
              },
            ],
          }),
