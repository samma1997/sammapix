    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose Photopea if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Need to edit PSD, XCF, or Sketch files in the browser</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Need layers, masks, brushes, or advanced selection tools</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Want a full Photoshop-like experience without paying for Adobe</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">Photopea</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
      ...
      <div className="mb-14 p-6 border border-gray-200 dark:border-[#2A2A2A] rounded-md bg-gray-50/40 dark:bg-[#1E1E1E]">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mb-4">When to use SammaPix instead of Photopea</h2>
        ...
        <ul className="space-y-3 text-sm text-gray-600 dark:text-[#A3A3A3]">
          <li className="flex items-start gap-3">
            ...
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">Your images are already edited and ready to publish.</strong> SammaPix is the last step in your workflow- compress, convert, rename, download.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You have more than one image to process.</strong> Batch workflows in Photopea are manual and slow. SammaPix handles 20 files simultaneously.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You care about Core Web Vitals or page speed.</strong> AI rename, WebP conversion, and compression are all designed with web performance in mind.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">You want EXIF data removed before sharing.</strong> SammaPix strips all metadata client-side - Photopea does not.</span>
          </li>
        </ul>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/tools/compress" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Compress up to 20 images at once- free, in-browser</p>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400 dark:text-[#737373] group-hover:text-gray-600 transition-colors" strokeWidth={1.5} />
          </Link>
          <Link href="/tools/exif" className="flex items-center justify-between p-4 border border-gray-200 dark:border-[#2A2A2A] rounded-md hover:bg-gray-50 transition-colors group">
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-[#E5E5E5]">EXIF Remover</p>
              <p className="text-xs text-gray-500 dark:text-[#737373] mt-0.5">Strip GPS, device, and timestamp metadata from photos</p>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400 dark:text-[#737373] group-hover:text-gray-600 transition-colors" strokeWidth={1.5} />
          </Link>
        </div>
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">Ready to optimize images in seconds?</h2>
