    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-14">
        ...
        <div className="p-5 border border-gray-200 dark:border-[#2A2A2A] bg-gray-50/60 dark:bg-[#1E1E1E] rounded-md">
          <p className="text-xs font-semibold text-gray-500 dark:text-[#737373] uppercase tracking-wide mb-2">Choose FilterPixel if you…</p>
          <ul className="space-y-1.5 text-sm text-gray-700 dark:text-[#A3A3A3]">
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Need cloud-based processing integrated with a CMS</li>
            <li className="flex items-start gap-2"><Check className="h-4 w-4 text-gray-400 dark:text-[#737373] mt-0.5 shrink-0" strokeWidth={2} /> Prefer a server-side API for automated pipelines</li>
          </ul>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#252525] border-b border-gray-200 dark:border-[#2A2A2A]">
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-500 dark:text-[#737373] w-1/4">FilterPixel</th>
              </tr>
            </thead>
            <tbody>
              {tableRows.map((row, i) => (
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
              <Shield className="h-4 w-4 text-gray-500 dark:text-[#737373]" strokeWidth={1.5} />
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              FilterPixel is a pure optimization tool. It shrinks file sizes, but it does not help with SEO. SammaPix uses Google Gemini to analyze each image and generate a descriptive, SEO-optimized filename and alt text. Upload <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">photo_001.jpg</code>, get back <code className="text-xs bg-gray-100 dark:bg-[#252525] px-1 py-0.5 rounded">wooden-cabin-snowy-mountain-colorado-winter.webp</code> with a full alt text description. For bloggers and content teams, this eliminates one of the most tedious parts of the publishing workflow- manually writing meaningful filenames for every image.
            </p>
          </div>
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2 flex items-center gap-2">
      ...
      <div className="mb-14 p-6 border border-gray-200 dark:border-[#2A2A2A] rounded-md bg-gray-50/40 dark:bg-[#1E1E1E]">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mb-4">Who is switching from FilterPixel to SammaPix?</h2>
        ...
        <ul className="space-y-3 text-sm text-gray-600 dark:text-[#A3A3A3]">
          <li className="flex items-start gap-3">
            ...
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">Cost reduction:</strong> Eliminating a $15–$30/month subscription that feels excessive for a task the browser can handle natively.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">Privacy requirements:</strong> Client contracts or internal policies that prohibit uploading images to third-party servers.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">SEO workflow:</strong> Needing to rename images with descriptive filenames and add alt text- neither of which FilterPixel provides.</span>
          </li>
          <li className="flex items-start gap-3">
            <Check className="h-4 w-4 text-indigo-500 mt-0.5 shrink-0" strokeWidth={2} />
            <span><strong className="text-gray-800 dark:text-[#E5E5E5]">WebP adoption:</strong> Needing to serve WebP images and wanting format conversion bundled with compression in a single step.</span>
          </li>
        </ul>
      </div>
      ...
      <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-8 text-center bg-gray-50 dark:bg-[#1E1E1E]">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#E5E5E5] mb-2">A better photo optimizer- and it&apos;s free</h2>
