...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! Free users get 5 upscales per day with images up to 1500px. Pro users ($9/month) get 100 upscales per day with no size limits, plus access to all 20+ SammaPix tools with higher limits.",
  },
];
