...
import { ArrowLeft, FileText, Shield, Layers, CheckCircle2 } from "lucide-react";
import Link from "next/link";
import PdfMergeClient from "@/components/tools/PdfMergeClient";
import PdfMergeHeroDemo from "@/components/tools/PdfMergeHeroDemo";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-4 lg:gap-8 items-center">
          <div>
            ...
            <p className="text-sm text-[#737373] dark:text-[#A3A3A3] leading-relaxed mb-3">
              ...
              <strong className="text-[#171717] dark:text-[#E5E5E5]">Drag to reorder</strong>{" "}
              before merging, no page limits, runs entirely in your browser. No upload, no signup.
            </p>
