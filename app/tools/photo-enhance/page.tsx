...
export const metadata: Metadata = {
  title: "Batch AI Photo Enhancer Free — Enhance 20 Photos at Once",
  description:
    "Drop 20+ photos. AI cleans up JPEG compression, sharpens grain, and upscales 2x in batch. Download as ZIP. 100% browser-based, no upload, no signup. Best for WhatsApp photo dumps, screenshot batches, and old scans.",
  keywords: [
    "batch ai photo enhancer",
    "bulk photo enhancer",
    "ai photo enhancer free",
    "improve image quality batch",
    "enhance multiple photos online",
    "ai image enhancer batch",
    "photo quality enhancer ai",
    "sharpen multiple photos",
    "remove jpeg artifacts bulk",
    "ai image upscaler 2x batch",
    "photo enhancer free no signup",
    "improve old photo quality",
    "enhance whatsapp photos batch",
  ],
  alternates: { canonical: `${APP_URL}/tools/photo-enhance` },
  openGraph: {
    title: "Batch AI Photo Enhancer Free — Enhance 20 Photos at Once",
    description:
      "Drop 20+ photos. AI enhances them in batch, downloads as ZIP. 100% browser-based, no upload, no signup, free.",
  ...
  twitter: {
    ...
    title: "Batch AI Photo Enhancer Free — 20 Photos at Once",
    description:
      "Drop 20+ photos, AI enhances them in batch, download as ZIP. Runs in your browser. No upload, no signup.",
  },
};
...
const howToSteps = [
  {
    title: "Drop multiple photos",
    desc: "Select 5, 10, 20 photos at once. JPG, PNG, or WebP, up to 15 MB each.",
  },
  {
    title: "Click Enhance",
    desc: "The AI processes the whole batch sequentially in your browser. Each photo takes ~5-15s.",
  },
  {
    title: "Download as ZIP",
    desc: "When the batch finishes, download all enhanced photos as a single ZIP. Or download individually.",
  },
];
          ...
          <div>
            <div className="flex items-start gap-3 mb-3">
              ...
              <h1 className="text-2xl sm:text-3xl font-semibold text-[#171717] dark:text-[#E5E5E5] tracking-tight leading-tight">
                Batch AI Photo Enhancer. Enhance 20 Photos at Once
              </h1>
            </div>

            <p className="text-[15px] text-[#737373] dark:text-[#A3A3A3] leading-relaxed mb-4">
              Drop 20+ photos at once. AI cleans up JPEG compression, removes grain,
              sharpens soft details, and upscales 2x — for every photo in the batch.
              Download the whole result as a ZIP. Runs 100% in your browser. No upload,
            ...
            <div className="text-xs text-[#737373] dark:text-[#A3A3A3] bg-[#FFFBEB] dark:bg-[#3B2814] border border-[#FDE68A] dark:border-[#78350F] rounded-md px-3 py-2 mb-4 leading-relaxed">
              ...
              this AI does not fix motion blur or defocus blur. For that, dedicated
              deblurring is coming to the Pro tier with server-side AI.
            </div>

            <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-[#525252] dark:text-[#A3A3A3]">
              <span className="inline-flex items-center gap-1">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#16A34A]" strokeWidth={2} />
                Batch up to 20 (100 Pro)
              </span>
              <span className="inline-flex items-center gap-1">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#16A34A]" strokeWidth={2} />
                Download as ZIP
