...
export const metadata: Metadata = {
  ...
  description:
    "Complete suite of 29 free browser-based image and video tools. Compress JPG/PNG, convert WebP, PDF to image, AI rename, AI alt text, combo tools, remove EXIF, batch process, apply film effects. No uploads, no account needed for core tools.",
  keywords: [
    "free image tools",
    "image compressor",
    "webp converter",
      ...
      <section className="border-b border-gray-100 dark:border-[#2A2A2A] bg-[#FAFAFA] dark:bg-[#191919]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <p className="text-sm text-gray-500 dark:text-[#737373] max-w-lg leading-relaxed">
            29 free browser-based tools. No uploads, no signup needed for most tools.
          </p>
        </div>
      </section>
