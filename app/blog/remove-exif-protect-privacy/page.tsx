            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 mt-4">
              {[
                ...
                },
                {
                  icon: Eye,
                  title: "Camera & Device",
                  detail: "Camera make, model, lens type, focal length, aperture, shutter speed, ISO.",
                },
                {
                  icon: Shield,
                  title: "Timestamp",
                  detail: "Exact date and time the photo was taken, often to the millisecond.",
                },
                {
                  icon: AlertTriangle,
                  title: "Device Serial / Software",
                  detail: "Camera serial number, firmware version, editing software used (e.g. Lightroom, Photoshop).",
                },
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                },
                {
                  ...
                  body: 'Select "Remove GPS only" to strip just the location fields while preserving camera settings metadata (useful if you are a photographer keeping technical data), or select "Remove all EXIF" to strip everything.',
                },
                {
                  step: "5",
