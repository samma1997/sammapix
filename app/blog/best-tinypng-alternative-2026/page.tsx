...
export const metadata: Metadata = {
  ...
  description:
    `Looking for a TinyPNG alternative? SammaPix compresses JPG, PNG, WebP, GIF and AVIF in your browser, no uploads, no file limits, ${TOOL_COUNT} tools free. See the full comparison.`,
  alternates: {
  ...
  twitter: {
    ...
    title: "TinyPNG Alternative: Why Photographers Switch to SammaPix (2026)",
    description:
      `Honest comparison of TinyPNG vs SammaPix: privacy, batch limits, pricing, formats, and ${TOOL_COUNT} tools vs 1. Which free image compressor is actually better in 2026?`,
...
const articleSchema = {
  ...
  headline: POST_TITLE,
  description:
    `Looking for a TinyPNG alternative? SammaPix compresses images in your browser with no uploads, no file limits, and ${TOOL_COUNT} tools, all free. Honest 2026 comparison.`,
  url: POST_URL,
    ...
    <>
      <BlogArticleLayout
        ...
        summary={[
          ...
          `Beyond compression, SammaPix offers ${TOOL_COUNT} tools including WebP conversion, EXIF removal, AI renaming, and batch resize in one workflow.`,
