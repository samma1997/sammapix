...
const POST_TITLE = "Best Image Compression Tools 2026: TinyPNG Isn't #1";
const POST_DESCRIPTION =
  "TinyPNG isn't the best in 2026. We tested 10 compressors on 100 real photos — measuring file size, SSIMULACRA visual quality, and speed. The winner saved 73%.";
