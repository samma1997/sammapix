...
import { ArrowRight, Shield, MapPin, Camera, AlertTriangle } from "lucide-react";
  ...
  return (
    <>
      <BlogArticleLayout
        ...
        description="Every photo your smartphone takes includes your exact GPS coordinates embedded in the file. Most people have no idea. Here is what that data reveals, why it matters, and how to strip it in seconds before you share anything online."
        date="2026-02-24"
        dateFormatted="Feb 24, 2026"
        tags={["Privacy"]}
        readingTime={6}
        headings={[
          { id: "what-is-gps-metadata", title: "What is GPS metadata and where does it come from?" },
          { id: "real-world-privacy-risks", title: "Real-world privacy risks from GPS photo metadata" },
          { id: "social-media-strip", title: "Do social media platforms remove GPS metadata automatically?" },
          { id: "how-to-remove-gps", title: "How to remove GPS data from photos using SammaPix EXIF Viewer" },
          { id: "other-methods", title: "Other methods to remove GPS from photos" },
          { id: "compress-and-clean", title: "Compress and clean in one step" },
          { id: "faq", title: "FAQ" },
        ]}
        summary={[
          "Every smartphone photo embeds GPS coordinates accurate to within a few meters, revealing your exact location to anyone who downloads the file.",
          "Social media platforms like Instagram and Facebook strip EXIF data, but many other channels (email, iMessage, marketplaces) do not.",
          "SammaPix EXIF Viewer strips GPS metadata entirely in your browser - no upload, no server, no account required.",
          "The SammaPix compress tool also strips all EXIF metadata automatically as part of the compression process.",
          "Always remove GPS data from photos before sharing publicly, especially for photos taken at home or frequently visited locations.",
        ]}
        heroImage={
          <figure>
            <img
      ...
      >
        ...
        {/* Section 1 */}
        <h2 id="what-is-gps-metadata" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
        ...
        {/* Section 2 */}
        <h2 id="real-world-privacy-risks" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
        ...
        {/* Section 3 */}
        <h2 id="social-media-strip" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
        ...
        <h2 id="how-to-remove-gps" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
        ...
        {/* Section 5 */}
        <h2 id="other-methods" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
        ...
        {/* Section 6 */}
        <h2 id="compress-and-clean" className="text-lg font-semibold text-gray-900 dark:text-[#E5E5E5] mt-10 mb-3">
