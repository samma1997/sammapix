  ...
  return (
    <>
      <BlogArticleLayout
        ...
        description="You take a photo on your iPhone, try to send it by email, and the upload stalls- or the recipient's inbox bounces it back. Modern smartphones produce photos between 3 MB and 8 MB each. Most email providers cap attachments well below that. This guide shows you exactly how to reduce image size for email in under two minutes, without losing any visible quality."
        date="2026-02-03"
        dateFormatted="February 3, 2026"
        tags={["Tools"]}
        readingTime={8}
        headings={[
          { id: "email-size-limits", title: "Email attachment size limits you need to know" },
          { id: "why-photos-too-big", title: "Why photos from your phone are always too big" },
          { id: "method-1-compress", title: "Method 1: Compress the image (fastest, best for single photos)" },
          { id: "method-2-resize", title: "Method 2: Resize the image dimensions" },
          { id: "method-3-webp", title: "Method 3: Convert to WebP (30% smaller than JPEG)" },
          { id: "method-4-combine", title: "Method 4: Combine all three for maximum reduction" },
          { id: "quick-reference", title: "Quick reference: how much each method reduces your photo" },
          { id: "batch-compress", title: "Tips for batch compressing multiple photos for email" },
          { id: "phone-compress", title: "What about using your phone to compress photos for email?" },
          { id: "faq", title: "Frequently asked questions" },
        ]}
        summary={[
          "Most email providers cap attachments at 20-25 MB total, and corporate email often limits to just 5-10 MB per email.",
          "Compressing a photo at quality 78-82 typically reduces a 5 MB iPhone photo to under 1 MB with no visible quality difference.",
          "Resizing to 1920px wide before compressing is the single most effective combination for email-sized photos.",
          "Converting to WebP delivers 30% smaller files than JPEG at equivalent quality, though not all email clients display WebP inline.",
          "All compression in SammaPix runs entirely in your browser - your photos never leave your device.",
        ]}
        heroImage={
          <figure>
            <img
        ...
        ctaBlock={
          <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-900 rounded-md p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] mb-4">
              Drag your photos into SammaPix and compress them to under 1 MB in seconds. Batch processing, ZIP download, and everything runs in your browser- your files never leave your device.
            </p>
      ...
      >
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="email-size-limits">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="why-photos-too-big">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="method-2-resize">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="method-3-webp">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="method-4-combine">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="batch-compress">
        ...
        <h2 className="text-lg font-semibold text-[#171717] dark:text-[#E5E5E5] mt-10 mb-4" id="phone-compress">
