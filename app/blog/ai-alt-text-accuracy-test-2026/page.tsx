  ...
  return (
    <>
      ...
      <BlogArticleLayout
        ...
        slug={SLUG}
        description="Alt text is no longer optional — it's a ranking factor, an accessibility requirement, and increasingly generated by AI. But how accurate are these AI-generated descriptions? I tested three leading models on 200 real photographs across 5 categories. The results surprised me."
        date={POST_DATE}
        ...
        summary={[
          ...
          "Claude 3.5 Sonnet is the most factually accurate (8.7/10) but often too verbose at 45 words average — penalizing its length score.",
      ...
      >
        ...
        <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed mb-3">
          Alt text is no longer optional — it is a ranking factor, an accessibility requirement, and increasingly generated by AI. But how accurate are these AI-generated descriptions? I tested three leading models — <strong className="text-gray-900 dark:text-[#E5E5E5]">Google Gemini 2.5 Flash</strong>, <strong className="text-gray-900 dark:text-[#E5E5E5]">GPT-4o</strong>, and <strong className="text-gray-900 dark:text-[#E5E5E5]">Claude 3.5 Sonnet</strong> — on 200 real photographs across 5 categories. The results surprised me.
        </p>
        <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed mb-3">
        ...
        <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed mb-3">
          The overall score is the unweighted average of all four criteria. Scoring was done manually by me — not by another AI model — to ensure human judgment on factual accuracy and real-world usefulness.
        </p>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-gray-50 dark:bg-[#252525] border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              ...
              , verbosity is a liability — screen readers read the entire alt text aloud, and excessively long descriptions annoy users.
            </p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-[#252525] border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              GPT-4o scored 8.8 on accuracy for screenshots — the highest single-model, single-category accuracy score. Its advantage is OCR: GPT-4o reads and incorporates text visible in the image, including button labels, error messages, and menu items. For SaaS companies, documentation sites, and tutorial blogs, this capability is critical. A screenshot&apos;s alt text should describe what the UI <em>says</em>, not just what it looks like.
            </p>
          </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              ...
              Highest SEO value (8.4), optimal length for product listings, naturally includes product-relevant keywords. Also the fastest and cheapest per image — critical when processing product catalogs with thousands of SKUs. Gemini&apos;s API pricing is approximately $0.0001 per image, making it viable for batch processing at scale.
            </p>
          </div>
          ...
          <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              ...
              Highest accessibility score (8.4) and factual accuracy (8.7). Claude provides the most complete descriptions of what is happening in an image — context, emotions, spatial relationships — which is exactly what screen reader users need. You may want to post-process Claude&apos;s output to trim it to 30 words or fewer.
            </p>
          </div>
          ...
          <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              <strong className="text-gray-900 dark:text-[#E5E5E5]">Use Gemini 2.5 Flash.</strong>{" "}
              Fastest response time (average 0.8 seconds per image vs 1.4s for GPT-4o and 1.9s for Claude in our tests), lowest cost per image, and highest overall score. When you need to process hundreds or thousands of images, Gemini&apos;s speed and cost advantages compound significantly. SammaPix uses Gemini for exactly this reason — learn more about{" "}
              <Link
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-md p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-[#A3A3A3] leading-relaxed">
              Gemini 2.5 Flash scored highest on SEO value for e-commerce (8.4/10). It naturally includes product keywords — brand, material, color, style — that match real search queries. Combined with its fast processing speed and low cost, Gemini is ideal for e-commerce catalogs with hundreds or thousands of products.
            </p>
          </div>
