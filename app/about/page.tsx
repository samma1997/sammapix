...
export const metadata: Metadata = {
  ...
  description:
    "I'm Luca Sammarco, Digital Product Builder and travel photographer. I built SammaPix — 28 free browser-based image tools used in 40+ countries. No uploads, no servers, everything runs in your browser.",
  keywords: [
    "luca sammarco",
      ...
      <main>
        ...
        <section className="bg-[#FAFAFA] dark:bg-[#111111] border-t border-[#E5E5E5] dark:border-[#2A2A2A] px-4 sm:px-8 py-12">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-sm text-[#525252] dark:text-[#A3A3A3] leading-relaxed mb-4">
              Today, SammaPix has 28 free tools used by photographers, bloggers, and developers in 40+ countries.
              ...
              {[
                {
                  ...
                  description:
                    "I design and develop SaaS tools, websites, and platforms. SammaPix is my latest product — 28 browser-based image tools used in 40+ countries.",
                },
                {
