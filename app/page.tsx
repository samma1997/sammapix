...
// FAQ — Brand/general only.
// Tool-specific FAQs (HEIC, WebP, EXIF, Find Duplicates, Film Filters, AI Rename,
// AI Photo Sort, Web Optimize, image compression, batch Instagram) have been moved
// to the dedicated tool pages to avoid SEO cannibalization of high-intent queries.
const FAQ_ITEMS: { question: string; answer: string }[] = [
  {
    question: "Is SammaPix really free?",
    answer:
      `Yes. All ${TOOL_COUNT} tools are free forever with no watermarks. The free plan includes 20 files per batch and 10 AI credits per day. Pro ($9/month) unlocks unlimited AI features, 500 files per batch, ZIP download, and the AI Workflow Pipeline. No credit card required for the free plan.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      "No account is needed for most tools. Only AI-powered tools (AI Rename, AI Alt Text, Transcribe) and AI combo tools require a free account to prevent API abuse.",
  },
  {
    question: "Can I use SammaPix on mobile?",
    answer:
      "Yes. SammaPix is fully responsive and works on iPhone, iPad, Android, and all mobile devices. All tools run directly in your mobile browser -- no app download needed.",
  },
  {
    question: "What's the difference between Free and Pro?",
    answer:
      `Free tier includes all ${TOOL_COUNT} tools with limits: 20 files per batch, 10 AI credits daily, no ZIP downloads. Pro ($9/month) removes all limits: 500 files per batch, 200 AI operations daily, ZIP downloads, no ads, and AI Workflow Pipeline access. Both plans offer zero uploads and full browser-based processing.`,
  },
  {
    question: "Is there a file size limit?",
    answer:
      "Individual files up to 100MB are supported. For batch processing, the total size can reach 1GB on Free tier (20 files) and 2GB on Pro tier (500 files). Processing happens in your browser's memory, so very large batches may slow down older devices.",
  },
  {
    question: "Does SammaPix work offline?",
    answer:
      "Core processing tools work offline once the page loads. AI-powered tools require internet since they connect to Google Gemini. You'll get a clear error if offline on AI tools.",
  },
  {
