...
const MILESTONES = [
  { count: 1, label: "First Friend", reward: "50 bonus AI ops", icon: Star },
  { count: 3, label: "Connector", reward: "150 bonus AI ops + badge", icon: Users },
...
const SHARE_MESSAGES = {
  twitter: (link: string) =>
    `If you edit photos for work, SammaPix is actually useful \u2014 AI rename, compress, HEIC convert, duplicate finder, all in the browser. Try it free (50 bonus AI ops): ${link}`,
  ...
  linkedin: (link: string) =>
    `I\u2019ve been using SammaPix to optimize images for web \u2014 AI-powered renaming, compression, HEIC conversion, all browser-based. If you work with images, it\u2019s worth trying. My referral link gives you 50 free AI ops: ${link}`,
  emailSubject: "A tool I've been using for photo workflows",
  emailBody: (link: string) =>
    `Hey,\n\nI've been using SammaPix for image optimization \u2014 AI rename, compress, HEIC convert, duplicate finder, all in the browser. No install needed.\n\nIf you sign up through my link, you get 50 free AI operations:\n${link}\n\nWorth checking out if you work with images regularly.`,
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 md:py-10 pb-20 space-y-8 md:space-y-12">
      ...
      <section className="text-center">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-[#171717] dark:text-[#E5E5E5] tracking-tight mb-2">
          Give 50 ops, get 25 back
        </h1>
        <p className="text-sm sm:text-base text-[#737373] dark:text-[#A3A3A3] max-w-md mx-auto leading-relaxed mb-8">
          Share your link with friends. They get 50 free AI operations when they sign up, and you earn 25 bonus ops for each signup.
        </p>
      ...
      <section>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <StatCard icon={Zap} label="AI ops earned" value={stats.opsEarned} accent />
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <HowItWorksStep
            step={2}
            title="They sign up"
            description="When someone signs up through your link, they get 50 free AI operations as a welcome bonus."
          />
          <HowItWorksStep
            step={3}
            title="You earn rewards"
            description="You receive 25 bonus AI ops per signup. Hit milestones for even bigger rewards."
          />
        </div>
      </section>
