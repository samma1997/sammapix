...
const TOOL_CATEGORIES: ToolCategory[] = [
  ...
  },
  {
    ...
    slugs: ["qr-code-generator", "qr-code-reader", "barcode-generator", "barcode-reader", "hash-generator", "password-generator", "url-encode-decode", "ico-generator", "color-picker"],
  },
  {
    label: "AI",
    icon: <Sparkles className="h-3.5 w-3.5" strokeWidth={1.5} />,
    slugs: ["ai-rename", "alt-text", "smartsort", "ai-organize", "image-to-text"],
  },
  {
