...
> = {
  "web-hosting": {
    ...
    src: "https://siteground.com/static/affiliate/en/NOPRICE/general_EN_general-hosting-leaderboard-light.jpg",
  ...
  wordpress: {
    ...
    src: "https://siteground.com/static/affiliate/en/NOPRICE/general_EN_wordpress-leaderboard-blue.jpg",
  ...
  woocommerce: {
    ...
    src: "https://siteground.com/static/affiliate/en/NOPRICE/general_EN_woocommerce-leaderboard-violet.jpg",
