...
const TOOLS: ToolWithCategory[] = [
  ...
  },
  {
    ...
    tagline: "Convert 7Z to ZIP in your browser — extract and repackage with folder structure preserved. No upload. 7Z needs special software; ZIP opens on any OS.",
    accent: "#0EA5E9",
    badges: ["Free", "Privacy", "No upload"],
  ...
  },
  {
    ...
    tagline: "Convert TAR archives (.tar, .tar.gz, .tgz, .tar.bz2, .tar.xz) to ZIP in your browser — extract and repackage with folder structure preserved. No upload.",
    accent: "#0EA5E9",
    badges: ["Free", "Privacy", "No upload"],
    Icon: IconTarToZip,
    category: ["Optimize"],
  ...
  },
  {
    ...
    tagline: "Open and extract Java .jar and .war archives in your browser. View class files, resources and META-INF. No Java install, no upload.",
    accent: "#6366F1",
    badges: ["Free", "Privacy", "No upload"],
    Icon: IconExtractJar,
    category: ["Optimize"],
