...
export default function WebpToJpgClient() {
  ...
  const downloadAll = async () => {
    ...
    saveAs(blob, "sammapix-webp-to-jpg.zip");
  };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {uiState === "idle" && items.length === 0 && (
          <div
            ...
            className={`border-2 border-dashed rounded-md p-10 text-center cursor-pointer transition-colors ${
              isDragOver
                ? "border-[#10B981] bg-[#10B98115] dark:bg-[#10B98108]"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-[#1E1E1E] border border-[#E5E5E5] dark:border-[#2A2A2A] rounded-md p-4">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-[#525252] dark:text-[#A3A3A3] mb-1.5">
                    Background (for transparent WebPs)
                  </label>
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs rounded border ${
                        background === "white"
                          ? "border-[#10B981] bg-[#10B98115] text-[#10B981] font-medium"
        ...
        {uiState === "processing" && (
          <div className="text-center py-12">
            <Loader2 className="mx-auto h-10 w-10 text-[#10B981] animate-spin mb-4" strokeWidth={1.5} />
