...
const PERSONA_TOOLS: Record<Persona, PersonaConfig> = {
  photographer: {
    ...
    tools: [
      ...
      { name: "FilmLab", href: "/tools/filmlab", why: "Add analog film looks" },
      { name: "GeoSort", href: "/tools/geosort", why: "Organize by shooting location" },
      { name: "TravelMap", href: "/tools/travelmap", why: "Map your photo journey" },
    ],
  ...
  blogger: {
    ...
    tools: [
      ...
      { name: "ResizePack", href: "/tools/resizepack", why: "Perfect sizes for your CMS" },
    ],
  ...
  ecommerce: {
    ...
    tools: [
      ...
      { name: "ResizePack", href: "/tools/resizepack", why: "Platform-specific sizes" },
      { name: "WebP", href: "/tools/webp", why: "Faster product pages" },
      { name: "StampIt", href: "/tools/stampit", why: "Protect with watermarks" },
    ],
  ...
  developer: {
    ...
    tools: [
      ...
      { name: "EXIF Lens", href: "/tools/exif", why: "Strip metadata, save bytes" },
      { name: "AI Alt Text", href: "/tools/alt-text", why: "WCAG compliance" },
      { name: "ResizePack", href: "/tools/resizepack", why: "Responsive image sizes" },
    ],
  ...
  social: {
    ...
    tools: [
      { name: "ResizePack", href: "/tools/resizepack", why: "Instagram, Twitter, LinkedIn sizes" },
      { name: "CropRatio", href: "/tools/croproatio", why: "Perfect aspect ratios" },
      { name: "Compress", href: "/tools/compress", why: "Fast uploads" },
      { name: "StampIt", href: "/tools/stampit", why: "Brand watermarks" },
      { name: "FilmLab", href: "/tools/filmlab", why: "Consistent visual style" },
    ],
