...
const nextConfig = {
  ...
  serverExternalPackages: ["onnxruntime-node", "@tensorflow/tfjs", "upscaler", "@upscalerjs/esrgan-slim", "libarchive.js", "three", "docx-preview", "jspdf", "html2canvas"],
        ...
        headers: [
          ...
          { key: "Cross-Origin-Resource-Policy", value: "cross-origin" },
          {
            ...
            value: [
              ...
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' blob: https://js.stripe.com https://pagead2.googlesyndication.com https://www.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://connect.facebook.net https://accounts.google.com https://apis.google.com https://www.dropbox.com https://cdn.jsdelivr.net https://www.clarity.ms https://*.clarity.ms https://static.cloudflareinsights.com https://*.adtrafficquality.google",
              ...
              "img-src 'self' data: blob: https://lh3.googleusercontent.com https://avatars.githubusercontent.com https://siteground.com https://*.siteground.com https://picsum.photos https://fastly.picsum.photos https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://res.cloudinary.com https://images.unsplash.com https://images.pexels.com https://www.facebook.com https://www.google.com https://www.googleadservices.com https://www.clarity.ms https://*.clarity.ms https://c.bing.com",
              // media-src blob: is required for client-side <video>/<audio> previews
              // (e.g. the Compress Video before/after player using createObjectURL)
