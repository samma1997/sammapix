...
const baliPhotos: TripPhoto[] = [
  {
    id: "bal-01",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/01-bali-hindu-temple-dwarapala-naga-stone-statue",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/01-bali-hindu-temple-dwarapala-naga-stone-statue",
    alt: "Ancient Balinese Dwarapala guardian stone statue & intricate Naga carving at a temple in Bali, Indonesia. Traditional architecture.",
    caption: "Bali — ancient guardians watch over sacred grounds",
    description:
      "Ancient grey stone guardian statues stand sentry at a Balinese temple entrance. Intricate carvings depict powerful mythological figures, weathered by time and elements. Soft, diffused light highlights the exquisite details of the Balinese Hindu artistry. A vibrant red tiled roof peeks in the background, contrasting with the detailed stone work and hints of green foliage, evoking Bali's spiritual ambiance.",
  ...
  {
    id: "bal-02",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/02-balinese-elder-volcanic-coast-cloudy-sky-bali-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/02-balinese-elder-volcanic-coast-cloudy-sky-bali-indonesia",
    alt: "Elder Balinese man in white udeng and patterned sarong sits on textured volcanic rock, ocean waves under cloudy sky, Bali, Indonesia.",
    caption: "Balinese Coast — Elder's tranquil ocean gaze",
    description:
      "A dignified Balinese elder in traditional white udeng and patterned sarong sits thoughtfully on a rugged, dark volcanic rock outcrop. He gazes towards the churning ocean under a dramatic cloudy sky. The scene captures a moment of serene contemplation by the Balinese coast, where steps of a temple or spiritual site recede behind him. Weathered rock textures, subtle yellow offerings, and the rhythmic waves evoke Bali's profound connection to nature and spirituality.",
    location: "Coastal Bali, Bali, Indonesia",
    date: "2025-03-30",
    width: 2758,
    height: 3677,
  },
  {
    id: "bal-03",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/03-bali-temple-guardian-stone-statue-ancient-carving",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/03-bali-temple-guardian-stone-statue-ancient-carving",
    alt: "Close-up weathered Balinese guardian statue, intricate grey stone carving, fierce face, traditional temple art, Bali, Indonesia.",
    caption: "Bali — silent sentinel of sacred traditions",
    description:
      "A magnificent weathered stone guardian statue stands sentinel at a Balinese temple. Intricate carvings reveal a fierce, watchful expression and elaborate crown, embodying ancient spiritual protection. Soft, diffused light accentuates the rich textures of the grey stone, hinting at centuries of devotion. A blur of traditional offerings in the background reinforces the sacred atmosphere, capturing Bali's timeless spiritual essence.",
    location: "Bali, Indonesia",
    date: "2025-03-30",
    width: 2971,
    height: 3961,
  ...
  {
    id: "bal-04",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/04-pura-taman-ayun-water-temple-bali-cloudy-day",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/04-pura-taman-ayun-water-temple-bali-cloudy-day",
    alt: "Pura Taman Ayun, Bali. Ancient mossy stone wall, tranquil water garden, traditional Balinese thatched pavilions under cloudy sky.",
    caption: "Taman Ayun — serene water temple under cloudy skies",
    description:
      "An ancient Balinese water temple complex reveals its serene beauty under a soft, overcast sky. Moss-covered stone walls frame a tranquil water garden, where vibrant green lily pads float peacefully. Traditional thatched-roof pavilions (bale) and a multi-tiered meru shrine stand majestically amidst lush tropical foliage. The diffused light enhances the mystical atmosphere, highlighting the timeless grandeur of this sacred site in Bali.",
    location: "Pura Taman Ayun, Mengwi, Bali, Indonesia",
    date: "2025-03-30",
    width: 3024,
    height: 4032,
  },
  {
    id: "bal-05",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/05-pura-taman-ayun-bali-meru-towers-overcast-sky-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/05-pura-taman-ayun-bali-meru-towers-overcast-sky-indonesia",
    alt: "Ancient Balinese Hindu temple Pura Taman Ayun meru towers under a cloudy sky, traditional architecture, Bali, Indonesia.",
    caption: "Bali — Ancient meru spires, mystical clouds",
    description:
      "Towering meru shrines with characteristic multi-tiered thatched roofs dominate this Balinese Hindu temple complex. The ancient stone structures, adorned with intricate carvings, are softly illuminated by the diffused light of an overcast sky. Verdant foliage frames the sacred grounds, emphasizing the serene, timeless atmosphere. This spiritual sanctuary in Bali, Indonesia, invites contemplation amidst its traditional grandeur.",
    location: "Pura Taman Ayun, Mengwi, Badung Regency, Bali, Indonesia",
    date: "2025-03-30",
    width: 2607,
    height: 3476,
  },
  {
    id: "bal-06",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/06-pura-taman-ayun-bali-indonesia-hindu-temple-meru",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/06-pura-taman-ayun-bali-indonesia-hindu-temple-meru",
    alt: "Pura Taman Ayun temple, Bali. Ancient Balinese meru shrines and ornate moss-covered stone architecture under an overcast sky.",
    caption: "Pura Taman Ayun — ancient Balinese temple spires, tranquil scene",
    description:
      "An ancient Balinese temple complex reveals its serene beauty. Ornate, moss-covered stone carvings adorn a candi bentar gateway. Rows of tiered meru shrines, with dark thatched roofs, recede under a diffused, overcast sky. The soft light accentuates intricate details and the lush green foliage of a towering tree. This sacred space embodies Bali's spiritual heritage and timeless tranquility.",
    location: "Pura Taman Ayun, Mengwi, Badung Regency, Bali, Indonesia",
    date: "2025-03-30",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-07",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/07-pura-taman-ayun-bali-hindu-temple-meru-towers-lotus",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/07-pura-taman-ayun-bali-hindu-temple-meru-towers-lotus",
    alt: "Pura Taman Ayun temple, Bali, Indonesia. Historic Balinese Hindu meru towers & traditional architecture beside a lotus pond on an overcast day.",
    caption: "Pura Taman Ayun — ancient serenity, lotus-filled moat",
    description:
      "A tranquil scene unfolds at Pura Taman Ayun in Bali, Indonesia. Multiple tiered meru towers with dark thatched roofs rise under a soft, overcast sky, lending a moody elegance. Traditional Balinese stone architecture, adorned with intricate carvings, lines a reflective lotus pond. The moss-kissed stone wall in the foreground guides the eye through this sacred complex, revealing the profound spiritual atmosphere of this ancient Hindu water temple.",
    location: "Pura Taman Ayun, Mengwi, Badung Regency, Bali, Indonesia",
    date: "2025-03-30",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-08",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/08-pura-taman-ayun-bali-temple-meru-lotus-pond-cloudy-sky",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/08-pura-taman-ayun-bali-temple-meru-lotus-pond-cloudy-sky",
    alt: "Pura Taman Ayun temple, Bali. Eleven-tiered meru pagoda, carved stone, lotus pond, lush red flowers under dramatic cloudy sky.",
    caption: "Pura Taman Ayun — moody meru tiers, tranquil lotus pond",
    description:
      "Towering meru pagodas of Pura Taman Ayun rise majestically under a dramatic, overcast Balinese sky. Rain-kissed thatched roofs and intricate stone carvings showcase traditional Hindu architecture. Lush tropical foliage, vibrant red flowers, and serene lotus pads on the surrounding pond add to the temple's tranquil, spiritual atmosphere. This ancient royal water temple is a testament to Bali's rich cultural heritage.",
    location: "Pura Taman Ayun, Mengwi, Badung Regency, Bali, Indonesia",
    date: "2025-03-30",
    width: 2722,
    height: 3629,
  ...
  {
    id: "bal-09",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/09-balinese-deity-statue-gold-grey-temple-bali-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/09-balinese-deity-statue-gold-grey-temple-bali-indonesia",
    alt: "Intricate Balinese Hindu deity statue in grey and gold, holding offerings, against a thatched roof and green trees. Bali, Indonesia.",
    caption: "Bali — divine guardian amidst lush serenity",
    description:
      "A magnificent Balinese deity statue stands tall, adorned in intricate grey and gold. Its serene face gazes forward, holding sacred offerings, symbolizing protection and prosperity. Detailed craftsmanship on the crown, jewelry, and flowing drapery captures the spiritual essence of Bali. A traditional thatched roof structure and lush tropical trees frame this cultural icon against a soft, overcast sky, highlighting the island's unique blend of artistry and nature.",
  ...
  {
    id: "bal-10",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/10-ubud-monkey-forest-bali-mossy-statue-ancient-carving",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/10-ubud-monkey-forest-bali-mossy-statue-ancient-carving",
    alt: "Moss-covered ancient stone statue of mythological demon figure with monkeys in Ubud Monkey Forest, Bali, Indonesia.",
    caption: "Ubud Monkey Forest — stone guardians, nature's embrace",
    description:
      "A moss-covered stone sculpture dominates the lush Ubud Monkey Forest in Bali. This ancient carving depicts a mythological figure, its intricate details softened by vibrant green growth. Smaller monkey statues cling to its form, blending seamlessly with the tropical jungle's embrace. Dappled sunlight filters through the canopy, highlighting the statue's weathered texture and the mystical atmosphere of this sacred Balinese site. It embodies the timeless artistry and natural beauty of Indonesia.",
    location: "Ubud Monkey Forest, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  },
  {
    id: "bal-11",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/11-bali-ubud-monkey-forest-mossy-statue-monkeys-jungle",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/11-bali-ubud-monkey-forest-mossy-statue-monkeys-jungle",
    alt: "Ubud Monkey Forest, Bali: Moss-covered stone statue of laughing deity with monkeys amidst lush jungle foliage, ancient Balinese art.",
    caption: "Ubud Monkey Forest — laughing gods, jungle's embrace",
    description:
      "An ancient moss-covered stone statue captivates in Bali's Sacred Monkey Forest. Bathed in dappled sunlight filtering through the dense jungle canopy, this laughing deity, adorned with clinging monkey figures, evokes a sense of timeless mystique. Vibrant green moss highlights intricate details, embodying the pervasive natural spirituality of Ubud. The cool, verdant atmosphere envelopes this sacred art, a true Balinese treasure.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Gianyar, Bali, Indonesia",
    date: "2025-03-31",
    width: 1713,
    height: 2284,
  },
  {
    id: "bal-12",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/12-bali-ubud-sacred-monkey-forest-macaque-corn-wildlife",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/12-bali-ubud-sacred-monkey-forest-macaque-corn-wildlife",
    alt: "Long-tailed macaque eating corn on a railing in Bali's Sacred Monkey Forest Sanctuary, Ubud. Lush tropical jungle backdrop.",
    caption: "Ubud — macaque's serene corn feast",
    description:
      "A long-tailed macaque sits thoughtfully on a sturdy railing within Bali's Sacred Monkey Forest Sanctuary. Bathed in soft, filtered sunlight, its expressive face and grizzled fur are rendered with captivating detail. It gently holds pieces of yellow corn, a moment of quiet focus amidst the vibrant tropical foliage. The lush, verdant jungle creates a rich, emerald backdrop, highlighting this iconic Balinese wildlife encounter.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Gianyar Regency, Bali, Indonesia",
    date: "2025-03-31",
    width: 2645,
    height: 3527,
  },
  {
    id: "bal-13",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/13-bali-ubud-monkey-forest-macaques-grooming-wildlife",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/13-bali-ubud-monkey-forest-macaques-grooming-wildlife",
    alt: "Two long-tailed macaques grooming on a stone path in Ubud Monkey Forest, Bali. One relaxes while the other meticulously grooms.",
    caption: "Ubud Monkey Forest — tender jungle grooming ritual",
    description:
      "Two long-tailed macaques engage in a tender grooming ritual on a worn stone path. One primate reclines peacefully on its back, eyes closed in contentment, as its companion meticulously tends to its fur. Soft, diffused light highlights their tawny coats and the textured paving stones. This intimate moment captures the intrinsic social bonds within Bali's vibrant wildlife, set against the subtle stone architecture of the sacred forest sanctuary.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  },
  {
    id: "bal-14",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/14-bali-temple-gate-mossy-guardian-statue-closed-sign",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/14-bali-temple-gate-mossy-guardian-statue-closed-sign",
    alt: "Moss-covered Balinese temple gate with ornate metalwork, guardian statue, and offerings. Yellow 'CLOSED' sign visible. Bali, Indonesia.",
    caption: "Bali — moss-kissed temple guardians, a closed door",
    description:
      "A richly detailed Balinese temple gate stands shrouded in lush green moss, hinting at ancient origins. An ornate guardian statue, also moss-kissed, watches over the entrance, with a small canang sari offering placed at its base. A weathered metal gate, adorned with intricate patterns, bears a yellow 'CLOSED' sign. The soft, diffused light illuminates the spiritual essence of this tropical scene, capturing Bali's timeless cultural heritage.",
    location: "Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-15",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/15-bali-ubud-monkey-forest-ancient-stone-carving-moss",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/15-bali-ubud-monkey-forest-ancient-stone-carving-moss",
    alt: "Ubud Monkey Forest, Bali: Intricate moss-covered ancient stone carving with monkey figures and jungle scene relief.",
    caption: "Ubud, Bali — Moss-kissed stone, ancient jungle tales",
    description:
      "Ancient Balinese stone carvings, richly detailed with monkey figures and lush jungle motifs, emerge from a tapestry of vibrant green moss. Soft, dappled light illuminates the intricate textures, highlighting the artistry and the passage of time. The humid tropical climate allows nature to gently reclaim these sacred narratives, creating a serene, timeless atmosphere in the heart of Bali's cultural landscape. This artwork embodies the island's spiritual connection to its environment.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 2444,
    height: 3258,
  ...
  {
    id: "bal-16",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/16-bali-ubud-moss-stone-guardian-statue-ancient-temple",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/16-bali-ubud-moss-stone-guardian-statue-ancient-temple",
    alt: "Moss-covered Balinese stone guardian statue with intricate details, ancient temple, Ubud, Bali, Indonesia.",
    caption: "Bali — ancient guardian sleeps amidst the emerald jungle",
    description:
      "A venerable Balinese stone guardian statue stands sentinel, richly adorned with vibrant green moss that thrives in the tropical humidity. Its weathered features, carved with a fierce expression, hint at centuries of stories. Lush, verdant jungle foliage gently frames the background, casting dappled light on the ancient stone. This intricate carving exemplifies Bali's deep spiritual heritage, showcasing artistry enduring amidst nature's embrace.",
    location: "Ancient Balinese Temple, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  },
  {
    id: "bal-17",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/17-bali-ubud-temple-mossy-guardian-statues-ancient-culture",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/17-bali-ubud-temple-mossy-guardian-statues-ancient-culture",
    alt: "Moss-covered ancient Balinese stone guardian statues at an Ubud temple. Intricate carvings, vibrant green moss, traditional architecture details.",
    caption: "Ubud — ancient guardians in emerald embrace",
    description:
      "Lush green moss blankets ancient stone guardian statues within a traditional Balinese temple. Intricate carvings, depicting mythical figures, are slowly reclaimed by nature, creating a timeless, mystical atmosphere. Soft, diffused light accentuates the vibrant emerald hues against the dark stone. This evocative scene captures Bali's spiritual heritage amidst its tropical embrace.",
    location: "Balinese Temple, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 2319,
    height: 3092,
  },
  {
    id: "bal-18",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/18-balinese-temple-courtyard-frangipani-bali-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/18-balinese-temple-courtyard-frangipani-bali-indonesia",
    alt: "Sunlit Balinese temple courtyard featuring traditional red-tiled roofs, ornate pavilions, and a gnarled frangipani tree, Bali, Indonesia.",
    caption: "Bali Temple — ancient sunlit whispers",
    description:
      "Morning light illuminates a serene Balinese temple courtyard. Traditional red-tiled roofs crown ornate pavilions, showcasing timeless craftsmanship. A gnarled frangipani tree, sacred in Balinese culture, casts dramatic shadows across the sun-dappled stone paving. The tranquil atmosphere invites contemplation amidst lush tropical foliage. This ancient sanctuary in Bali offers a timeless glimpse into spiritual tradition and architectural beauty.",
    location: "Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-19",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/19-bali-ubud-monkey-forest-stone-dragon-statue-jungle",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/19-bali-ubud-monkey-forest-stone-dragon-statue-jungle",
    alt: "Moss-covered stone dragon statue guarding ancient steps amidst hanging banyan roots in a mystical Bali jungle temple.",
    caption: "Bali — ancient dragon guardian of mystic jungle paths",
    description:
      "A magnificent moss-covered stone dragon statue stands sentinel over worn steps, deep within a sacred Balinese jungle. Ancient banyan tree roots cascade around, forming a mystical backdrop. Diffused light filters through the dense canopy, highlighting intricate carvings and the rich green patina. This guardian evokes Bali's spiritual heritage, inviting exploration of forgotten pathways.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 2302,
    height: 3069,
  ...
  {
    id: "bal-20",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/20-bali-ubud-monkey-forest-dragon-guardian-stone-statue-moss",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/20-bali-ubud-monkey-forest-dragon-guardian-stone-statue-moss",
    alt: "Moss-covered stone dragon guardian statue in Sacred Monkey Forest Sanctuary, Ubud, Bali. Ancient Balinese temple art amid jungle roots.",
    caption: "Ubud, Bali — ancient guardian statue, jungle's embrace",
    description:
      "A weathered stone dragon statue stands guard in Bali's sacred forest. Vibrant green moss clings to its ancient features, detailing its formidable scales and open maw. Dappled sunlight filters through the dense canopy, illuminating intricate Balinese carvings, creating a mystical atmosphere. Twisted roots of ancient trees weave in the soft-focus background, underscoring the timeless beauty of this spiritual Indonesian landscape.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-21",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/21-bali-ubud-sacred-monkey-forest-macaque-corn-feast",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/21-bali-ubud-sacred-monkey-forest-macaque-corn-feast",
    alt: "Long-tailed macaque monkey eating corn cob on paved path at Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia.",
    caption: "Ubud Monkey Forest — macaque's vibrant corn feast",
    description:
      "A captivating scene unfolds within Bali's Sacred Monkey Forest Sanctuary. A long-tailed macaque intently enjoys a golden corn cob, its gaze focused amidst scattered kernels. Lush jungle greenery softly blurs in the background, hinting at the sanctuary's vibrant ecosystem. Diffused natural light illuminates the textured pavement where other macaques also partake in the abundant feast. This intimate wildlife moment captures the playful spirit of Ubud, Indonesia's renowned sanctuary, offering a glimpse into their daily lives.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-03-31",
    width: 2762,
    height: 3683,
  ...
  {
    id: "bal-22",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/22-garuda-wisnu-kencana-statue-vishnu-garuda-bali",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/22-garuda-wisnu-kencana-statue-vishnu-garuda-bali",
    alt: "Close-up of monumental Garuda Wisnu Kencana statue in Bali. Intricate bronze patina on Lord Vishnu and mythical Garuda against blue sky.",
    caption: "Garuda Wisnu Kencana — majestic legends touch the sky",
    description:
      "A breathtaking close-up reveals the monumental Garuda Wisnu Kencana statue in Bali, Indonesia. Morning light sculpts intricate details of Lord Vishnu, crowned in gold, riding the mythical Garuda. The weathered bronze patina gleams with rich turquoise and verdigris tones against a vivid blue sky. This epic sculpture embodies Hindu mythology, offering a powerful sense of ancient culture and spiritual grandeur.",
    location: "Garuda Wisnu Kencana Cultural Park, Ungasan, Badung, Bali, Indonesia",
    date: "2025-04-04",
    width: 2208,
    height: 2944,
  },
  {
    id: "bal-23",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/23-garuda-wisnu-kencana-gwk-statue-bali-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/23-garuda-wisnu-kencana-gwk-statue-bali-indonesia",
    alt: "Monumental Garuda Wisnu Kencana (GWK) statue in Bali, Indonesia, showcasing intricate copper details against a clear blue sky.",
    caption: "Garuda Wisnu Kencana — Bali's majestic guardian, azure sky",
    description:
      "The colossal Garuda Wisnu Kencana statue commands attention, its immense copper and brass form rising dramatically against Bali's vibrant blue sky. Sunlight brilliantly illuminates the intricate details of Lord Vishnu mounted atop the mythical Garuda bird, highlighting the rich patination and powerful contours. This iconic monument within the cultural park stands as a profound symbol of Indonesian heritage and spiritual artistry, captivating visitors with its sheer scale and exquisite craftsmanship.",
    location: "Garuda Wisnu Kencana Cultural Park, Ungasan, Badung Regency, Bali, Indonesia",
    date: "2025-04-04",
    width: 2916,
    height: 3888,
  },
  {
    id: "bal-24",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/24-garuda-wisnu-kencana-statue-bali-indonesia-cultural-park",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/24-garuda-wisnu-kencana-statue-bali-indonesia-cultural-park",
    alt: "Monumental Garuda Wisnu Kencana statue, Bali. Adult and child walk on green lawn under blue sky. Indonesian cultural park.",
    caption: "Garuda Wisnu Kencana — Bali's majestic guardian spirit",
    description:
      "Sunlight bathes the colossal Garuda Wisnu Kencana statue in Bali, a monumental tribute to Hindu mythology. Its intricate stone details rise grandly against a vibrant blue sky, adorned with scattered white clouds. A vast green lawn stretches before the deity, where an adult and child highlight the immense scale of this iconic Indonesian landmark. The atmosphere is awe-inspiring, a blend of ancient culture and architectural marvel.",
    location: "Garuda Wisnu Kencana Cultural Park, Pecatu, Badung Regency, Bali, Indonesia",
    date: "2025-04-04",
    width: 2984,
    height: 3979,
  },
  {
    id: "bal-25",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/25-garuda-wisnu-kencana-vishnu-statue-head-bali-indonesia",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/25-garuda-wisnu-kencana-vishnu-statue-head-bali-indonesia",
    alt: "Close-up of Vishnu's serene bronze face and ornate crown at Garuda Wisnu Kencana Cultural Park, Bali, under a bright blue sky.",
    caption: "Garuda Wisnu Kencana — majestic deity against azure sky",
    description:
      "A monumental bronze statue of Vishnu dominates the frame, showcasing intricate details of his serene face, closed eyes, and majestic crown. The weathered patina of the sculpture contrasts beautifully with the vivid, cloud-dappled azure sky. This iconic Balinese deity, a symbol of preservation, stands tall at GWK Cultural Park, embodying spiritual grandeur and artistic prowess under the brilliant tropical sun. Its imposing presence offers a profound cultural experience.",
    location: "Garuda Wisnu Kencana Cultural Park, Ungasan, Bali, Indonesia",
    date: "2025-04-04",
    width: 2954,
    height: 3939,
  },
  {
    id: "bal-26",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/26-bali-hindu-temple-gate-stone-swastika-sacred-entrance",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/26-bali-hindu-temple-gate-stone-swastika-sacred-entrance",
    alt: "Traditional Balinese temple gate, weathered volcanic stone steps, white metal doors with Hindu swastika symbols. Sacred shrine, Bali.",
    caption: "Bali — sacred temple's ancient stone gate",
    description:
      "Sunlight illuminates a weathered Balinese temple gate, crafted from dark volcanic stone. Ornate steps ascend to a white metal door featuring prominent Hindu swastika symbols. Beyond, a traditional multi-tiered roof hints at the sacred shrine within. A sign restricts entry to worshipers only, emphasizing the spiritual sanctity. Strong shadows underscore the intricate textures and ancient aura of this significant Balinese cultural site.",
    location: "Bali, Indonesia",
    date: "2025-04-04",
    width: 2821,
    height: 3761,
  ...
  {
    id: "bal-27",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/27-melasti-beach-bali-cliff-coastline-turquoise-ocean",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/27-melasti-beach-bali-cliff-coastline-turquoise-ocean",
    alt: "Melasti Beach, Bali, Indonesia: turquoise ocean waves meet rocky sea wall and winding road beneath lush green cliffs on sunny day.",
    caption: "Melasti Beach — turquoise embrace of Bali's rugged coast",
    description:
      "Azure ocean waves gently caress a dark rocky sea wall and winding coastal road below towering, verdant cliffs at Melasti Beach, Bali. Bright daylight illuminates the dramatic landscape, showcasing the stunning transition from deep blue to vibrant turquoise waters. Sparse white clouds drift across a clear sky, enhancing the serene and majestic atmosphere of this iconic Indonesian coastline.",
    location: "Melasti Beach, Ungasan, Bali, Indonesia",
    date: "2025-04-04",
    width: 3024,
    height: 4032,
  },
  {
    id: "bal-28",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/28-bali-ubud-monkey-forest-macaque-eating-corn",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/28-bali-ubud-monkey-forest-macaque-eating-corn",
    alt: "Balinese long-tailed macaque monkey eating yellow corn cob, peeking from weathered stone temple wall, Ubud Monkey Forest, Bali.",
    caption: "Ubud Monkey Forest — a curious moment observed",
    description:
      "A curious long-tailed macaque peeks from weathered stone architecture at Ubud Monkey Forest, Bali. Its dark, expressive eyes reflect soft light as it intently savors a vibrant piece of yellow corn. The ancient, textured structure provides a rustic, dappled backdrop, hinting at the sanctuary's serene, spiritual atmosphere. This intimate portrait captures wildlife thriving amidst the island's rich cultural heritage.",
    location: "Sacred Monkey Forest Sanctuary, Ubud, Bali, Indonesia",
    date: "2025-04-04",
    width: 3024,
    height: 4032,
  ...
  {
    id: "bal-29",
    src: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/29-uluwatu-cliff-ocean-view-bali-indonesia-tropical",
    srcThumb: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_600/v1/sammapix/portfolio/bali/29-uluwatu-cliff-ocean-view-bali-indonesia-tropical",
    alt: "Dramatic Uluwatu cliffs in Bali, Indonesia, rising from turquoise Indian Ocean, lush green vegetation, white waves crash below.",
    caption: "Uluwatu, Bali — majestic cliffs, endless turquoise",
    description:
      "Uluwatu's dramatic limestone cliffs plunge into the vibrant turquoise Indian Ocean under a brilliant blue sky. Lush tropical greenery clings to the rugged rock faces, contrasting with the frothy white waves crashing below. The scene captures Bali's raw coastal beauty, bathed in warm tropical light. This iconic landmark offers breathtaking panoramic views of nature's powerful artistry.",
    location: "Uluwatu, Badung Regency, Bali, Indonesia",
    date: "2025-04-04",
    width: 2574,
    height: 3432,
  },
...
export const trips: Trip[] = [
  ...
  },
  {
    ...
    endDate: "2025-04-04",
    coverSrc: "https://res.cloudinary.com/do9hrcwn1/image/upload/c_limit,f_auto,q_auto,w_1200/v1/sammapix/portfolio/bali/27-melasti-beach-bali-cliff-coastline-turquoise-ocean",
    excerpt:
      "Six days across Bali — clifftop temples, the sacred monkey forest of Ubud, and the turquoise coast of Uluwatu.",
    description:
      "From the moss-covered shrines of Pura Taman Ayun to the cheeky macaques of Ubud’s Sacred Monkey Forest and the dramatic limestone cliffs of Uluwatu, this collection captures the spiritual heart and wild coastline of Bali, Indonesia — each frame shot in late March 2025.",
    photoCount: baliPhotos.length,
    photos: baliPhotos,
    tags: ["temples", "beaches", "wildlife", "culture", "landscape", "cliffs"],
  },
];
