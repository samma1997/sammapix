...
export const POSTS: Post[] = [
  ...
  { slug: "favicon-best-practices-2026", title: "Favicon Best Practices 2026: 4 Sizes That Matter (SVG, Dark Mode, PWA)", description: "Most favicon guides list 22 sizes. You only need 4. The exact PNG/SVG/ICO setup for crisp icons across Chrome, Safari, dark mode, iOS, and PWA — with the 4 HTML tags to copy-paste.", date: "2026-04-22", tags: ["Performance"], coverImage: "/blog/covers/favicon-best-practices-2026.webp" },
  ...
  { slug: "best-free-topaz-gigapixel-alternatives-2026", title: "Topaz Gigapixel Pricing 2026: $199/year — Or Use 7 Free Alternatives", description: "Tired of Topaz's $199/year subscription? We tested 7 free upscalers on the same 50 photos: max scale (4x/8x), portrait quality, speed, browser vs install. The winner that beat Gigapixel on faces.", date: "2026-04-10", tags: ["Tools"], coverImage: "/blog/covers/best-free-topaz-gigapixel-alternatives-2026.webp" },
  ...
  { slug: "which-apps-strip-photo-metadata", title: "Does WhatsApp Strip GPS? 12 Apps Tested (Instagram Removes, Signal Hides) [2026]", description: "We sent the same photo through 12 apps and checked the EXIF: Instagram, WhatsApp, Signal, iMessage, Reddit, Telegram. The 4 apps secretly leaking your GPS — and the WhatsApp document trick that exposes everyone.", date: "2026-04-06", tags: ["Privacy"], coverImage: "/blog/covers/which-apps-strip-photo-metadata.webp" },
