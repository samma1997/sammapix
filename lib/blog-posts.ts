...
export const POSTS: Post[] = [
  ...
  { slug: "favicon-best-practices-2026", title: "Favicon 2026: The 4 Sizes That Actually Matter (Skip the Other 18)", description: "Most favicon guides list 22 sizes. You only need 4. The exact PNG/SVG/ICO setup for crisp icons across Chrome, Safari, dark mode, iOS, and PWA — with the 4 HTML tags to copy-paste.", date: "2026-04-22", tags: ["Performance"], coverImage: "/blog/covers/favicon-best-practices-2026.webp" },
  ...
  { slug: "best-free-topaz-gigapixel-alternatives-2026", title: "Topaz Gigapixel Alternatives 2026: 7 Free Tools (Skip the $199/year)", description: "Tired of Topaz's $199/year subscription? We tested 7 free upscalers on the same 50 photos: max scale (4x/8x), portrait quality, speed, browser vs install. The winner that beat Gigapixel on faces.", date: "2026-04-10", tags: ["Tools"], coverImage: "/blog/covers/best-free-topaz-gigapixel-alternatives-2026.webp" },
