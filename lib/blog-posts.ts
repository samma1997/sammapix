...
export const POSTS: Post[] = [
  ...
  { slug: "favicon-best-practices-2026", title: "Favicon Best Practices 2026: Sizes, SVG, Dark Mode, PWA", description: "Every favicon size that matters in 2026, how to serve SVG + ICO together, dark mode variants, PWA manifest icons, and the four HTML tags to add to every site.", date: "2026-04-22", tags: ["Performance"], coverImage: "/blog/covers/favicon-best-practices-2026.webp" },
